...
<template>
    <div class="border-t border-gray-200 space-y-6 py-6">
        <h2 class="text-2xl font-black">Detalles Ventas:</h2>
        <p class="text-xl font-black text-gray-500">Productos Vendidos</p>

        <ul role="lis" class="mt-6 divide-y divide-gray-200 border-t border-gray-200 text-sm font-medium text-gray-500">
